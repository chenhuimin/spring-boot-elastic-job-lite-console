...
package com.chm.dangdang.ddframe.job.lite.console.restful;

import com.chm.dangdang.ddframe.job.lite.console.service.JobAPIService;
import com.chm.dangdang.ddframe.job.lite.console.service.impl.JobAPIServiceImpl;
...
public final class ServerOperationRestfulApi {
  ...
  public void disableServerJob(@PathParam("serverIp") final String serverIp,
  ...
  @DELETE
  @Path("/{serverIp}/jobs/{jobName}/disable")
  public void enableServerJob(@PathParam("serverIp") final String serverIp,
      @PathParam("jobName") final String jobName) {
  ...
  public void shutdownServerJob(@PathParam("serverIp") final String serverIp,
      @PathParam("jobName") final String jobName) {
  ...
  public void removeServerJob(@PathParam("serverIp") final String serverIp,
      @PathParam("jobName") final String jobName) {
